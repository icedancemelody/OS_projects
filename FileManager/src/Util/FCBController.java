...
public class FCBController {
    ...
    //更新目录
    public FCB_List createFolder(String folderName, String folderPath, FCB_List fatherFolder) {
        //0.创建当前的日期
        Date date = new Date();
        ...
        newfolder.setFatherFolder(fatherFolder);//新的文件夹要指明它的父亲
        fatherFolder.addFile(newfolder);//父亲也要指明它有新的孩子
